...
const Footer = () => {
  ...
  return (
    <S.Footer>
      ...
      <p>
        @ {currentYear} <a href="https://chronosphere.io">Chronosphere</a> - Built on the OpenTelemetry Demo (<a href="https://github.com/open-telemetry/opentelemetry-demo">Source Code</a>)
      </p>
      <PlatformFlag />
    </S.Footer>
  );
